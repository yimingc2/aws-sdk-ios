...
@interface AWSPinpointSDKResources ()

@property (nonatomic, strong) NSDictionary *definitionDictionary;

@end

@implementation AWSPinpointSDKResources

+ (instancetype)sharedInstance {
    static AWSPinpointSDKResources *_sharedResources = nil;
    static dispatch_once_t once_token;

    dispatch_once(&once_token, ^{
        _sharedResources = [AWSPinpointSDKResources new];
    });
